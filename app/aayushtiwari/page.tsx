      ...
      <section className="py-20 relative bg-[#121212]">
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="space-y-20">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <h3 className="text-3xl font-bold text-[#F7BD3A]">Celebrating Eye Health in Nepal | IAPB |</h3>
                <p className="text-gray-300 text-lg">
                  Led the creative and cinematography efforts for a key video project "Celebrating Eye Health in Nepal" with the International Agency for
                  the Prevention of Blindness (IAPB). Coordinated interviews and captured compelling footage of eye
                  health pioneers, delivering a powerful narrative that highlighted the impact of vision care
                  initiatives. Collaborated closely with the production and communications teams to help produce a
                  polished final video that effectively communicated IAPB's mission and engaged diverse audiences.
                </p>
                <div className="space-y-2">
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-[#F7BD3A] rounded-full"></div>
                    <span className="text-gray-300">Creative Direction & Visual Storytelling</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-[#F7BD3A] rounded-full"></div>
                    <span className="text-gray-300">Collaboration with Global IAPB Communications Team</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-[#F7BD3A] rounded-full"></div>
                    <span className="text-gray-300">Documentary Filmmaking & Interview Coordination</span>
                  </div>
                </div>
              </div>
              <div className="aspect-video rounded-2xl overflow-hidden border-2 border-[#F7BD3A]/30 shadow-2xl">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="relative">
              ...
              <div className="overflow-hidden rounded-2xl">
                ...
                >
                  {/* Slide 1 - 4 reels */}
                  <div className="w-full flex-shrink-0 flex justify-center space-x-6 px-4">
                    {[
                      ...
                      <div
                        key={index}
                        className="relative aspect-[9/16] w-72 rounded-2xl overflow-hidden border-2 border-[#F7BD3A]/30 shadow-2xl group cursor-pointer transition-transform duration-300 hover:scale-105"
                      >
                        <iframe
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex justify-center items-center space-x-6 flex-wrap gap-3">
            ...
            <Link
              ...
              target="_blank"
              className="group flex flex-col items-center space-y-2 p-3 rounded-xl bg-white/5 backdrop-blur-sm border border-gray-600/20 hover:border-blue-500/50 transition-all duration-300 hover:scale-110"
            >
              <div className="w-10 h-10 flex items-center justify-center rounded-full bg-[#1877F2] group-hover:bg-[#166FE5] transition-all duration-300">
                <svg className="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </div>
              <span className="text-xs text-gray-400 group-hover:text-[#1877F2] transition-colors duration-300">
                Facebook
              </span>
            </Link>
            ...
            <Link
              ...
              target="_blank"
              className="group flex flex-col items-center space-y-2 p-3 rounded-xl bg-white/5 backdrop-blur-sm border border-gray-600/20 hover:border-pink-500/50 transition-all duration-300 hover:scale-110"
            >
              <div className="w-10 h-10 flex items-center justify-center rounded-full bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCB045] group-hover:from-[#7B2CBF] group-hover:via-[#E91E63] group-hover:to-[#FF9800] transition-all duration-300">
                <svg className="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987c6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C4.198 14.895 3.708 13.744 3.708 12.447s.49-2.448 1.297-3.323C5.902 8.198 7.053 7.708 8.35 7.708s2.448.49 3.323 1.297c.897.875 1.387 2.026 1.387 3.323s-.49 2.448-1.297 3.323c-.875.897-2.026 1.387-3.323 1.387zm7.718 0c-1.297 0-2.448-.49-3.323-1.297-.897-.875-1.387-2.026-1.387-3.323s.49-2.448 1.297-3.323c.875-.897 2.026-1.387 3.323-1.387s2.448.49 3.323 1.297c.897.875 1.387 2.026 1.387 3.323s-.49 2.448-1.297 3.323c-.875.897-2.026 1.387-3.323 1.387z" />
                </svg>
              </div>
              <span className="text-xs text-gray-400 group-hover:text-[#E91E63] transition-colors duration-300">
                Instagram
              </span>
            </Link>
            ...
            <Link
              ...
              target="_blank"
              className="group flex flex-col items-center space-y-2 p-3 rounded-xl bg-white/5 backdrop-blur-sm border border-gray-600/20 hover:border-blue-600/50 transition-all duration-300 hover:scale-110"
            >
              <div className="w-10 h-10 flex items-center justify-center rounded-full bg-[#0A66C2] group-hover:bg-[#004182] transition-all duration-300">
                <svg className="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                </svg>
              </div>
              <span className="text-xs text-gray-400 group-hover:text-[#0A66C2] transition-colors duration-300">
                LinkedIn
              </span>
            </Link>
            ...
            <Link
              ...
              target="_blank"
              className="group flex flex-col items-center space-y-2 p-3 rounded-xl bg-white/5 backdrop-blur-sm border border-gray-600/20 hover:border-red-600/50 transition-all duration-300 hover:scale-110"
            >
              <div className="w-10 h-10 flex items-center justify-center rounded-full bg-[#FF0000] group-hover:bg-[#CC0000] transition-all duration-300">
                <svg className="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                </svg>
              </div>
              <span className="text-xs text-gray-400 group-hover:text-[#FF0000] transition-colors duration-300">
                YouTube
              </span>
            </Link>
            ...
            <Link
              ...
              target="_blank"
              className="group flex flex-col items-center space-y-2 p-3 rounded-xl bg-white/5 backdrop-blur-sm border border-gray-600/20 hover:border-gray-800/50 transition-all duration-300 hover:scale-110"
            >
              <div className="w-10 h-10 flex items-center justify-center rounded-full bg-black group-hover:bg-gray-900 transition-all duration-300">
                <svg className="h-5 w-5 text-[#FF0050]" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z" />
                </svg>
              </div>
              <span className="text-xs text-gray-400 group-hover:text-[#FF0050] transition-colors duration-300">
                TikTok
              </span>
            </Link>
          </div>
