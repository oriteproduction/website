  ...
  return (
    <main className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <section className="py-12 sm:py-16 relative bg-[#080808]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#6E3D1B] via-[#F7BD3A] to-[#FCE2A6] bg-clip-text text-transparent mb-6 sm:mb-8">
            Connect with Me
          </h2>
          <p className="text-sm sm:text-base text-gray-400 mb-8 sm:mb-12 max-w-2xl mx-auto px-2">
          ...
          <div className="flex justify-center items-center space-x-4 sm:space-x-6 flex-wrap gap-3">
            ...
            <Link
              ...
              target="_blank"
              className="group flex flex-col items-center space-y-1 sm:space-y-2 p-2 sm:p-3 rounded-xl bg-white/5 backdrop-blur-sm border border-gray-600/20 hover:border-blue-500/50 transition-all duration-300 hover:scale-110 touch-manipulation"
            >
              <div className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-[#1877F2] group-hover:bg-[#166FE5] transition-all duration-300">
            ...
            <Link
              ...
              target="_blank"
              className="group flex flex-col items-center space-y-1 sm:space-y-2 p-2 sm:p-3 rounded-xl bg-white/5 backdrop-blur-sm border border-gray-600/20 hover:border-pink-500/50 transition-all duration-300 hover:scale-110 touch-manipulation"
            >
              <div className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCB045] group-hover:from-[#7B2CBF] group-hover:via-[#E91E63] group-hover:to-[#FF9800] transition-all duration-300">
                <svg className="h-4 w-4 sm:h-5 sm:w-5 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              ...
              target="_blank"
              className="group flex flex-col items-center space-y-1 sm:space-y-2 p-2 sm:p-3 rounded-xl bg-white/5 backdrop-blur-sm border border-gray-600/20 hover:border-blue-600/50 transition-all duration-300 hover:scale-110 touch-manipulation"
            >
              <div className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-[#0A66C2] group-hover:bg-[#004182] transition-all duration-300">
                <svg className="h-4 w-4 sm:h-5 sm:w-5 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              ...
              target="_blank"
              className="group flex flex-col items-center space-y-1 sm:space-y-2 p-2 sm:p-3 rounded-xl bg-white/5 backdrop-blur-sm border border-gray-600/20 hover:border-red-600/50 transition-all duration-300 hover:scale-110 touch-manipulation"
            >
              <div className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-[#FF0000] group-hover:bg-[#CC0000] transition-all duration-300">
                <svg className="h-4 w-4 sm:h-5 sm:w-5 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              ...
              target="_blank"
              className="group flex flex-col items-center space-y-1 sm:space-y-2 p-2 sm:p-3 rounded-xl bg-white/5 backdrop-blur-sm border border-gray-600/20 hover:border-gray-800/50 transition-all duration-300 hover:scale-110 touch-manipulation"
            >
              <div className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-black group-hover:bg-gray-900 transition-all duration-300">
